...
class Operator:
    def __init__(self, matrix: matrices_types, *args):
        self.matrix = matrix

    def square_checker(self) -> matrices_types:
        raw_matrix = self.matrix.raw_matrix
    ...
    def multiply_scalar(matrix: matrices_types, scalar: [int, float]) -> matrices_types:
        ...
        result = Operator(Matrix(multiply)).square_checker()
        return result
